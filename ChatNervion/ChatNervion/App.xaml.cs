...
namespace ChatNervion
{
    ...
    sealed partial class App : Application
    {
		...
		public void SignalR()
		{
			conn = new HubConnection("https://SamChat.azurewebsites.net");
			proxy = conn.CreateHubProxy("ChatHub");
			conn.Start();

			proxy.On<ChatMessge>("broadcastMessage", OnMessage);

		}
		public void Broadcast(ChatMessge msg)
		{
			proxy.Invoke("Send", msg);
		}
		private async void OnMessage(ChatMessge msg)
		{
